...
<div className='flex mx-auto items-center mt-[2rem] justify-center py-[2rem]  flex-col gap-[3rem]'>
 ...
 <section ref={sectionRef} id="services" className="block lg:hidden py-16 lg:py-24 bg-gradient-to-br from-purple-50 to-pink-50 overflow-hidden">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className='rounded-2xl w-full min-h-full' style={{
          ...
          backgroundRepeat: 'no-repeat'
            ...
            <div ref={titleRef} className={`w-fit p-[2rem] sm:p-[3rem] lg:p-[5rem] rounded-2xl mx-auto text-center font-georgia text-[20px] sm:text-[25px] md:text-[30px] lg:text-[35px] mt-[2rem] sm:mt-[3rem] lg:mt-[5rem] transition-all duration-1000 ease-out ${
              isTitleVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-95'
            }`}>
            ...
            <div ref={buttonsRef} className='flex flex-wrap items-center justify-center mx-auto mt-[1rem] gap-2 sm:gap-3 lg:gap-5 px-4'>
...
<div className='flex mx-auto items-center mt-[1rem] sm:mt-[1.5rem] lg:mt-[2rem] justify-center py-[1rem] sm:py-[1.5rem] lg:py-[2rem] flex-col gap-[1.5rem] sm:gap-[2rem] lg:gap-[3rem]'>
            ...
            <div ref={inputRef} className={`relative transition-all duration-1000 ease-out w-full max-w-sm sm:max-w-md lg:max-w-lg ${
              isInputVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-6 scale-95'
            }`}>
              <input 
